// Trained mercenary neural-network weights (feed-forward 7->8->3, tanh).
// Order: W1 (8x7), B1 (8), W2 (3x8), B2 (3).
// These weights are the SAME ones embedded in pixel-game.html (var MERC_WEIGHTS).
